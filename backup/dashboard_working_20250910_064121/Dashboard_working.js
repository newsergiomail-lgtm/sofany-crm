...
const Dashboard = () => {
  ...
  const ordersStatusData = [
    { name: 'Новые', value: parseInt(ordersData.new_orders) || 0, color: '#3B82F6' },
    { name: 'В производстве', value: parseInt(ordersData.in_production) || 0, color: '#F59E0B' },
    { name: 'В пошиве', value: parseInt(ordersData.in_sewing) || 0, color: '#2563EB' },
    { name: 'Готовы', value: parseInt(ordersData.ready) || 0, color: '#10B981' },
    { name: 'Доставлены', value: parseInt(ordersData.delivered) || 0, color: '#8B5CF6' },
    { name: 'Срочные', value: parseInt(ordersData.urgent_orders) || 0, color: '#DC2626' }
