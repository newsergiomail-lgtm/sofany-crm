-- =====================================================
-- СПРАВОЧНИК ОПЕРАЦИЙ ДЛЯ МЯГКОЙ МЕБЕЛИ
-- =====================================================

-- Создаем таблицу справочника операций
...
-- Создаем таблицу справочника профессий
CREATE TABLE IF NOT EXISTS professions_catalog (
    id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    description TEXT,
    department VARCHAR(100) NOT NULL,
...
INSERT INTO operations_catalog (name, description, department, estimated_time, difficulty_level, required_skills, materials_needed, tools_required) VALUES
-- Раскрой материалов
...
INSERT INTO professions_catalog (name, description, department, skill_level, hourly_rate, required_education, responsibilities) VALUES
...
ANALYZE operations_catalog;
ANALYZE professions_catalog;
